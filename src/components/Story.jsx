      ...
      <div className="grid gap-8 md:grid-cols-2">
        {cards.map((card) => (
          ...
          >
            ...
            />
            <div className="absolute inset-y-0 left-0 w-px bg-gradient-to-b from-neon/0 via-neon/40 to-neon/0 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
