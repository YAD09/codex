...
const CTA = () => (
  <section className="section-padding bg-black">
    <motion.div
      className="relative mx-auto flex max-w-4xl flex-col items-start gap-8 rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-white/5 to-neon/10 p-12"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <motion.div
        className="absolute right-6 top-6 h-16 w-16 rounded-full border border-neon/30"
